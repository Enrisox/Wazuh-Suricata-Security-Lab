...
<br>
After completing the installation of Ubuntu server, and Kali Linux, and ensuring that the VMs were in bridge mode on the same network as the Wazuh server, I verified the IP addresses they obtained and confirmed that they could ping each other without issues.
